...
function Navbar() {
  return (
    <div className='p-8 flex items-center gap-50'>
      <div className=' flex pl-15 cursor-pointer gap-2 text-3xl text-orange-400 font-bold items-center'><img className='h-10 w-12' src={icons.logo} alt="logo" />Voynex</div>
      ...
      <div className='flex gap-10'>
        <div className=' hover:bg-orange-500 bg-orange-600 p-2 rounded-md cursor-pointer text-white font-semibold'>Log In</div>
